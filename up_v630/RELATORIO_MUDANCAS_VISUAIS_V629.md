# Relatório de mudanças — UP Entregador v6.30.0
...
- `versionCode`: 830.
- `versionName`: `6.30.0-ideal-premium-home-operacional`.
- `DriverRepository.APP_VERSION`: `6.30.0-ideal-premium-home-operacional`.
